...
class _FamilyOwnerHomeScreenState extends State<FamilyOwnerHomeScreen>
  ...
  void _updateSelectedAid(SelectedAidModel? aid) {
    ...
    if (aidStart != null) {
      if (aidStart.isBefore(now)) {
        ...
        // Aid is upcoming
        daysUntil = aidStart.difference(now).inDays;
      }
    }
  ...
  Widget _buildNextWithdrawalCard(BuildContext context) {
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: const Center(
                    child: Icon(Icons.card_giftcard_rounded, color: Color(0xFFEE3764), size: 24),
                  ),
                ),
                const SizedBox(width: 12),
                Expanded(
    ...
    // Get the icon based on aid type
    IconData aidIcon = Icons.celebration_rounded;
    switch (_selectedAid!.aidName) {
      case 'aid_kbir':
      case 'aid_sghir':
        aidIcon = Icons.mosque_rounded;
        break;
      case 'ramadan':
        aidIcon = Icons.nightlight_round;
        break;
      case 'valentine':
        aidIcon = Icons.favorite_rounded;
        break;
      case 'new_year':
        aidIcon = Icons.celebration_rounded;
        break;
      case 'back_to_school':
        aidIcon = Icons.menu_book_rounded;
        break;
      case 'independence_day':
      case 'revolution_day':
        aidIcon = Icons.flag_rounded;
        break;
      case 'mothers_day':
      case 'womens_day':
        aidIcon = Icons.local_florist_rounded;
        break;
    }
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Date row at bottom
              if (_selectedAid!.withdrawalStartDate != null &&
